...
const STORAGE_KEY = 'codestudio_tabs_v2';
const ACTIVE_TAB_KEY = 'codestudio_active_tab_v2';
const PERSISTENCE_ENABLED_KEY = 'codestudio_tab_persistence_enabled';
...
interface SerializedTab {
  ...
  projectPath?: string;
  selectedProject?: any; // Project object for projects tabs
  status: Tab['status'];
  ...
  static saveTabs(tabs: Tab[], activeTabId: string | null): void {
    ...
    try {
      ...
      const serializedTabs: SerializedTab[] = persistableTabs.map(tab => ({
        ...
        selectedProject: tab.selectedProject, // Persist selected project
